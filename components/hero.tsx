    ...
    >
      ...
      <div className="mx-auto max-w-[1440px] w-full px-12 py-16 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="flex flex-col items-start max-w-2xl">
          <h1 className="text-[52px] font-semibold text-neutral-900 tracking-tight leading-[1.3] font-[family-name:var(--font-noto-serif)] antialiased">
        ...
        {/* 右カラム：白枠と影（shadow）を除去 */}
        <div className="flex justify-center md:justify-end w-full">
          <div className="w-full max-w-[488px] aspect-[487/495] rounded-2xl overflow-hidden relative">
            <img
